...
using PredictionML.Model.DataModels;

namespace PredictionML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\logonrmlocal\Desktop\Code\Prediction\Prediction\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../PredictionML.Model/MLModel.zip";
